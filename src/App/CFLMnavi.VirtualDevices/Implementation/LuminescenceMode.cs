...
using OpenCvSharp;
using UnitsNet;
using ImageMetadata = Betrian.Imaging.Common.ImageMetadata;
using LightColor = Betrian.Devices.Thorlabs.Light.LightColor;
...
public sealed class LuminescenceMode : StageControllingModeBase, ILuminescenceMode, IDisposable
{
    ...
    private ImageWithMetadata TransformToImageWithMetadata(ImageWithMetadata source, Betrian.Imaging.Common.Metadata.Luminescence.StackInfo? stackInfo = null)
    {
        using var activity = AppTelemetry.DeviceActivitySource.StartActivity(CreateActivityName());
        ...
        return source with
        {
            LuminescenceMetadata = source.LuminescenceMetadata! with
            {
                ...
                Mode = _filterHandler.FilterPosition == FilterType.Fluorescence ?
                    Betrian.Imaging.Common.Metadata.Luminescence.LuminescenceMode.Fluorescence :
                    Betrian.Imaging.Common.Metadata.Luminescence.LuminescenceMode.Reflection,
                StackInfo = stackInfo,
