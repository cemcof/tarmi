...
using Betrian.App.Infrastructure.Options;
using Betrian.CflmNavi.App.Infrastructure;
using Betrian.TileSet.ImageSimulator;
...
internal class CflmNaviApplicationModule : ConfigureServicesModule, IPostConfigureApplication
{
    ...
    public void PostConfigure(IApplicationInitializationContext context)
    {
        ...
        {
            RegisterUnhandledExceptionHandlers(context.ServiceProvider.GetRequiredService<ILogger<CflmNaviApplicationModule>>(), Application.Current.Dispatcher);
        });
    }
