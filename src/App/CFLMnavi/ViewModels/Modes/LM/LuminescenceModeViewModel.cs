...
public partial class LuminescenceModeViewModel : VirtualDeviceViewModel
{
        ...
        )
    {
        ...
        var zStackGrabbingService = new ZStackGrabbingService(luminescenceVirtualDevice, loggerFactory.CreateLogger<ZStackGrabbingService>());
        ...
        var tileSet3DGrabbingService = new TileSet3DGrabbingService(luminescenceVirtualDevice, _logger, _virtualDevice);
        ...
        TileSetGrabbing = new LuminescenceTilesetGrabbingViewModel(_logger, windowService, stageNavigation, luminescenceVirtualDevice, projectManager, _genericImagingPipeline, safeStageControlling, LuminescenceImaging, _tileSetGrabbingService, tileSet3DGrabbingService, ZStackGrabbing, applicationConfig, this);
    }
    ...
    protected override async Task InitializeInternalAsync(ApplicationMode prevMode, CancellationToken cancellationToken)
    {
        ...
        _subscriptions.Add(_imagingPipeline.Histogram.Subscribe(histogram => HistogramData = histogram));
        ...
        _subscriptions.Add(_virtualDevice.CurrentActiveLightColor.Subscribe(HandleColorChanged));
    }
