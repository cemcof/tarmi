...
using Betrian.CflmNavi.App.Views.Projects;
...
public interface IWindowService : IService
{
    ...
    ImageChildVM? ShowImageSelectionDialog(ImageChildVM imageToBind, IEnumerable<ImageChildVM> luminescenceImages);
}
...
internal class WindowService : IWindowService
{
    ...
    internal void SetMainViewModel(MainWindowViewModel mainWindowViewModel)
    {
    ...
    public ImageChildVM? ShowImageSelectionDialog(ImageChildVM imageToBind, IEnumerable<ImageChildVM> luminescenceImages)
    {
