        ...
        where TDepth : unmanaged
{
    ...
    public Size Size => _mat.Size();
    public unsafe int Depth => sizeof(TDepth) * 8;
    public Mat Mat => _mat;
    public InputOutputArray InputOutputArray => _mat;
    public InputArray InputArray => _mat;
    public OutputArray OutputArray => _mat;
    ...
    public Image(string fileName)
    {
        ...
        _mat = CreateImageMatFromLoadedMat(mat);
    }
    ...
    {
        _mat = Mat.Zeros(height, width, GetMatType());
    }

    public Image(int width, int height, TColor color)
    {
        _mat = new Mat(height, width, GetMatType(), color.Scalar);
    }
