...
namespace Betrian.Imaging.Common.Tests.Metadata.Luminescence;
public class LuminescenceMetadataSerializationTests
{
    ...
    public void Serialization_of_known_xml_should_succeed()
    {
        ...
        <Metadata xmlns:i="http://www.w3.org/2001/XMLSchema-instance" xmlns="http://schemas.datacontract.org/2004/07/Betrian.Imaging.Common.Metadata.Luminescence">
          <Camera>
            <Binning>1</Binning>
